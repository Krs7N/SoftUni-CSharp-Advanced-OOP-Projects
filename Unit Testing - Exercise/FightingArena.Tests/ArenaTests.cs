namespace FightingArena.Tests
{
    ...
    public class ArenaTests
    {
        ...
        [Test]
        public void Test_CheckIfIReadOnlyCollectionOfWarriorsWorksProperly()
        {
        ...
        [Test]
        public void Test_CheckIfEnrollWorksProperly()
        {
            this.EnrollDefaultWarriors();
        ...
        public void Test_EnrollShouldThrowExceptionWhenThereIsSuchWarrior
        ...
        [Test]
        public void Test_CheckIfAttackWorksProperly()
        {
            this.EnrollDefaultWarriors();
        ...
        public void Test_FightShouldThrowExceptionWhenInvalidPlayer(string attacker, string defender)
        {
            this.EnrollDefaultWarriors();
            Assert.Throws<InvalidOperationException>(() =>
            {
